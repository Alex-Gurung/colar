...
class ConvertedSFTDataModule(pl.LightningDataModule):
    def __init__(self, dataset_name, tiny_dataset=False, epoch_scaling=1, dataset_dir=None, all_config=None):
        ...
        self.dataset_dir = Path(dataset_dir) if dataset_dir else Path("/mnt/disk/baseline_colar/ff_data_chat")
    ...
    def _create_dataset(self, raw_data: List[dict], mode: str) -> ConvertedSFTDataset:
        return ConvertedSFTDataset(raw_data)
